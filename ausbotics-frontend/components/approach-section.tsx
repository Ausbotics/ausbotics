...
const steps = [
  {
    ...
    title: "Discovery",
    description:
      "Workshops and consultations to map your business challenges and automation goals.",
  },
  {
    num: "02",
    Icon: Brush2,
    title: "Design",
    description:
      "Blueprints, conversation flows, and interactive prototypes reviewed with your team.",
  },
  {
    num: "03",
    Icon: Code,
    title: "Develop",
    description:
      "Agile, feedback-driven delivery  we build, test, and iterate until it's right.",
  },
  {
    num: "04",
    Icon: Send2,
    title: "Deploy",
    description:
      "Full launch with team training, ongoing optimisation, and dedicated support.",
  },
];
...
export function ApproachSection() {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="relative py-20 sm:py-24 bg-neutral-50 dark:bg-neutral-950 overflow-hidden"
      >
