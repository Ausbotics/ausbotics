  ...
  return (
    <section className="relative overflow-hidden px-4 py-20 sm:py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-4xl space-y-8 text-center">
        ...
        {/* Stats */}
        <div className="flex flex-wrap items-center justify-center gap-6 border-y border-border/30 py-6 text-center sm:gap-8">
          <div className="flex flex-col">
            <div className="text-2xl font-bold text-accent sm:text-3xl">{COURSES.length}</div>
        ...
        <div className="flex justify-center">
          <div className="rounded-lg border border-accent/20 bg-accent/5 px-6 py-3 text-sm text-muted-foreground">
