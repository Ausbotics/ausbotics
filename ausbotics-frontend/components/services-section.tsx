  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div data-animate="header" className="mb-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-6">
            ...
            <p className="text-[14px] text-muted-foreground leading-relaxed max-w-sm lg:text-right">
              Three integrated pillars built, deployed, and maintained by
              AusBotics end-to-end.
            </p>
          </div>
        </div>
        ...
        {/* Metrics strip */}
        <div
          data-animate="metrics"
          className="flex flex-wrap gap-px bg-border rounded-2xl overflow-hidden mb-10 sm:mb-12 border border-border"
        >
