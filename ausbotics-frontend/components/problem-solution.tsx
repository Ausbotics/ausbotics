    ...
    <section className="py-24 bg-neutral-50 dark:bg-neutral-950">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {problems.map(
            ({ icon: Icon, iconColor, iconBg, title, description }, index) => (
              <div
                key={index}
              ...
              >
                <div
                  className={`w-11 h-11 rounded-xl border flex items-center justify-center mb-5 ${iconBg}`}
                >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-7 h-7 rounded-full bg-primary/10 border border-primary/15 flex items-center justify-center shrink-0">
                  <TickCircle size={14} color="var(--icon-neutral)" />
                </div>
