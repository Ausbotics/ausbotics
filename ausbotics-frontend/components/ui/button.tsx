...
const buttonVariants = {
  ...
  brand: cn(
    ...
    "shadow-[0_4px_20px_rgba(0,0,0,0.10),0_1px_2px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.35)]",
    "hover:bg-primary",
    "hover:shadow-[0_8px_28px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.4)]",
  ),
  navy: cn(
    base,
...
function Button({
  ...
  return (
    <Comp
      data-slot="button"
      className={cn(buttonVariants[variant], sizeClass, className)}
      {...props}
    />
  );
}
